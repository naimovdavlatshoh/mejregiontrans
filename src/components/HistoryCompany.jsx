...
const data = [
    {
        icon: "🚛",
        title: "130 новых большегрузных автомобилей.",
        description: "Автопарк более 250 единиц техники",
    },
    {
        icon: "🏗",
    ...
    {
        icon: "🏢",
        title: "100+ завершенных строительных объектов.",
        description: "Проекты по всей стране",
    },
    {
        icon: "🚚",
        title: "500+ транспортных единиц.",
        description: "Грузовые и пассажирские перевозки",
    },
    {
        icon: "🏭",
        title: "30 современных заводов.",
