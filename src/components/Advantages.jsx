...
const advantages = [
    ...
    {
        title: "Транспортировка всех видов грузов (в том числе опасных, негабаритных)",
    ...
    {
        title: "Своевременный возврат и корректное оформление товарно-сопроводительной документации в точном соответствии с требованиями клиента",
