...
const TransportSection = () => {
    const services = [
        ...
        {
            title: "Осуществление интермодальных перевозок",
            description:
                "благодаря долгосрочным контрактам с надежными партнерами",
        },
        {
            title: "Полный комплекс транспортно-экспидиционных услуг",
            description:
